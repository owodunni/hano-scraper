...
// Source: github.com/owodunni/hano-scraper/internal/server/middlewares/metrics (interfaces: Metrics)
//
// Generated by this command:
//
//	mockgen -destination=mocks_test.go -package=metrics . Metrics
//
